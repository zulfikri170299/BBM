                            ...
                            <tr class="hover:bg-white/5 border-b border-white/5 last:border-0 text-sm text-slate-300">
                                ...
                                <td class="px-6 py-3 text-center whitespace-nowrap">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <form action="{{ route($rolePrefix.'.sounding.destroy', $item->id) }}" method="POST" class="inline" onsubmit="return confirm('Hapus data ini?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="p-1.5 bg-slate-800 text-rose-400 hover:bg-rose-500 hover:text-white rounded-lg transition-colors" title="Hapus">
