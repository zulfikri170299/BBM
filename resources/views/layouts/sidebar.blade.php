            ...
            <div class="space-y-1">
                ...
                <div x-show="reportsOpen" x-collapse style="display: none;" class="ml-9 submenu-line space-y-1 my-1">
                    ...
                    <a href="{{ route('admin.saldo-dialihkan.index') }}"
                        class="group submenu-item flex items-center py-2 px-4 text-xs font-medium rounded-lg transition-all active:scale-[0.98] {{ request()->routeIs('admin.saldo-dialihkan.*') ? 'text-white active-submenu-item' : 'text-slate-400 hover:text-white hover:bg-slate-800/50' }}">
            ...
            <div class="space-y-1">
                ...
                <div x-show="transactionsOpen" x-collapse style="display: none;" class="ml-9 submenu-line space-y-1 my-1">
                    <a href="{{ route('petugas.transaksi.index') }}"
                        class="group submenu-item flex items-center py-2 px-4 text-xs font-medium rounded-lg transition-all active:scale-[0.98] {{ request()->routeIs('petugas.transaksi.*') ? 'text-white active-submenu-item' : 'text-slate-400 hover:text-white hover:bg-slate-800/50' }}">
                        <div class="submenu-dot {{ request()->routeIs('petugas.transaksi.*') ? 'active-dot' : '' }}"></div>
                        Transaksi BBM
                    </a>
                    <a href="{{ route('petugas.hutang.index') }}"
                        class="group submenu-item flex items-center py-2 px-4 text-xs font-medium rounded-lg transition-all active:scale-[0.98] {{ request()->routeIs('petugas.hutang.*') ? 'text-white active-submenu-item' : 'text-slate-400 hover:text-white hover:bg-slate-800/50' }}">
