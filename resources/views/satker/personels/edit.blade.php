                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                @if (auth()->user()->role !== 'super_admin' && $personel->saldo > 0)
                                    ...
                                    <!-- Tooltip -->
                                    <div
                                        class="absolute inset-y-0 right-0 flex items-center pr-10 pointer-events-none text-slate-300">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M12 15v2m0 0v2m0-2h2m-2 0H10m4-11a4 4 0 11-8 0 4 4 0 018 0z"></path>
                                        </svg>
                                    </div>
                                    <div
                                        class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 bg-slate-800 text-white text-[10px] rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-10 shadow-xl font-bold uppercase tracking-wider">
                                        Jenis BBM tidak bisa diubah karena masih ada saldo
                                    </div>
                                @endif
                                <div
