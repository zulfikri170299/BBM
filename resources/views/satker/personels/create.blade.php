        ...
        <div class="max-w-lg mx-auto px-4 sm:px-6">
            ...
            <div
                ...
                <div class="p-5 sm:p-6 bg-slate-50 dark:bg-slate-800/50 border-b border-slate-200 dark:border-white/5">
                    ...
                    <p class="text-[10px] text-slate-600 dark:text-slate-400 font-bold uppercase tracking-wider mt-1">Input data personel
                        secara ringkas</p>
                </div>

                <div class="p-5 sm:p-6">
                    <form action="{{ route('satker.personels.store') }}" method="POST" class="space-y-4">
                        @csrf
