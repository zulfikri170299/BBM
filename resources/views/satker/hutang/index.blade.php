<x-app-layout>
    <div class="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6" x-data="{ 
        ...
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            <div class="space-y-1">
                <h1 class="text-3xl font-black text-slate-900 tracking-tight">Daftar Hutang BBM Satker</h1>
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                @foreach($hutangPerBbm as $jenis => $total)
                    <div
                        class="bg-white px-5 py-3 rounded-[1.5rem] border border-slate-50 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/50 overflow-hidden">
                ...
                <div class="flex items-center gap-4">
                    <form action="{{ route('satker.hutang.index') }}" method="GET" class="flex items-center gap-3">
                        ...
                        <select name="per_page" onchange="this.form.submit()"
                            class="text-xs font-bold border-slate-100 bg-white rounded-xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 py-1.5 pl-3 pr-8 transition-all">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left border-collapse">
                    <thead>
                        <tr class="text-[11px] text-slate-400 uppercase tracking-[0.15em] bg-slate-50/50">
                    ...
                    <tbody class="divide-y divide-slate-50">
                        @forelse($hutangs as $hutang)
                            <tr class="hover:bg-indigo-50/30 transition-colors group">
                                ...
                                <td class="px-8 py-2">
                                    <div>
                                        <div class="font-black text-slate-900 tracking-tight">{{ $hutang->nopol }}</div>
                                ...
                                <td class="px-8 py-2 text-center">
                                    <div class="font-bold text-slate-700">{{ $hutang->nama_driver ?? '-' }}</div>
                                </td>
                                <td class="px-8 py-2 text-center">
                                ...
                                <td class="px-8 py-2 text-right">
                                    @if($hutang->status === 'belum_dibayar')
                                        <button
                                            ...
                                            class="inline-flex h-9 items-center justify-center px-5 bg-indigo-600 text-white font-black text-[11px] uppercase tracking-widest rounded-xl hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-100 active:scale-95 mb-0.5">
                                            Bayar Hutang
                                        </button>
                                    @else
                                        <span
                            ...
                            <tr>
                                <td colspan="6" class="px-8 py-20 text-center">
                                    <div class="flex flex-col items-center">
                                        <div
                                            class="w-16 h-16 bg-slate-50 rounded-[2rem] flex items-center justify-center text-slate-200 mb-4">
        ...
        <div x-show="showModal" class="fixed inset-0 z-50 flex items-center justify-center p-4" x-cloak>
            ...
            <div x-show="showModal" x-transition:enter="ease-out duration-300"
                ...
                class="relative bg-white rounded-[3rem] shadow-2xl overflow-hidden max-w-xl w-full border border-white/20">
                ...
                <div
                    ...
                    <div class="relative flex justify-between items-center">
                        <div class="flex items-center gap-4">
                            <div
                                class="w-12 h-12 bg-white/20 backdrop-blur-md rounded-2xl flex items-center justify-center border border-white/30 shadow-inner">
                ...
                <div class="p-10 space-y-8">
                    <!-- Summary Card -->
                    <div
                        class="bg-slate-50/50 rounded-[2rem] p-8 border border-slate-100 relative group overflow-hidden">
                        <div
                        ...
                        <div class="flex items-center justify-between mb-6">
                            <span
                                ...
                                Tagihan</span>
                            <span
                                class="px-3 py-1 bg-white text-indigo-600 font-black text-[10px] rounded-full border border-indigo-50 shadow-sm"
                        ...
                        <div class="grid grid-cols-2 gap-8">
                            <div class="space-y-1">
                                <label class="text-[9px] font-black text-slate-400 uppercase tracking-widest">No.
                                    Polisi</label>
                                <p class="text-2xl font-black text-slate-900 leading-tight tracking-tight"
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <button type="button" @click="showModal = false"
                            class="w-full py-4 text-slate-400 hover:text-slate-600 hover:bg-slate-50 font-black rounded-2xl transition-all text-[10px] uppercase tracking-[0.2em]">
                            Batalkan
                        </button>
                    </div>
                </div>
