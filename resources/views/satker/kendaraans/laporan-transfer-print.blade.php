...
<head>
    ...
    <style>
        ...
        .header h2 { margin: 4px 0; font-size: 13px; font-weight: normal; color: #555; }
        .header p { margin: 3px 0; font-size: 10px; color: #777; }
        table { width: 100%; border-collapse: collapse; margin-top: 15px; }
        th { background-color: #2d3748; color: #fff; padding: 8px 6px; text-align: left; font-size: 10px; text-transform: uppercase; letter-spacing: 0.5px; }
        ...
        .badge-blue { background-color: #ebf5ff; color: #1a56db; }
        .badge-green { background-color: #f0fdf4; color: #15803d; }
        .summary-table { width: 35%; margin-left: auto; margin-top: 25px; }
        .summary-table th { background-color: #059669; font-size: 11px; }
        .summary-table td { padding: 6px 10px; }
        .footer { margin-top: 30px; font-size: 9px; color: #999; display: flex; justify-content: space-between; border-top: 1px solid #e2e8f0; padding-top: 10px; }
        .arrow { color: #059669; font-weight: bold; }
...
<body>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <span class="badge {{ ($riwayat->kendaraan->jenis_bbm ?? '') == 'Pertamina Dex' ? 'badge-green' : 'badge-blue' }}">
    ...
    <table class="summary-table">
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <span class="badge {{ $jenis == 'Pertamina Dex' ? 'badge-green' : 'badge-blue' }}">{{ $jenis }}</span>
                </td>
