    ...
    <style>
        * {
        ...
        .card {
            ...
            @php
                $bgImage = str_contains(strtolower($kendaraan->jenis_bbm), 'dex') 
        ...
        <div class="card" id="kartu-bbm">
            ...
            <div class="content">
                <div class="qr-area">
                    ...
                    <div class="qr-label">{{ $kendaraan->barcode }}</div>
                </div>
                <div class="info-area">
                    <div class="info-item">
                        <div class="label-small">Jenis Kendaraan</div>
                        <div class="val-medium">{{ $kendaraan->jenis_kendaraan }}</div>
                    </div>
                    <div class="info-item">
                        <div class="val-xlarge">{{ $kendaraan->no_polisi }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="footer-area">
                <div class="pill-bbm {{ str_contains(strtolower($kendaraan->jenis_bbm), 'dex') ? 'dex' : 'pertamax' }}">
                    <div class="dot-status"></div>
                    <div class="bbm-label">{{ $kendaraan->jenis_bbm }}</div>
                </div>
