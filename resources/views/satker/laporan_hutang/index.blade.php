        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 sm:p-6 mb-6">
            <form action="{{ route('satker.laporan-hutang.index') }}" method="GET"
                ...
                <div>
                    ...
                    <select name="status" id="status" class="mt-1 block w-full border-slate-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm text-sm font-medium h-[42px]">
