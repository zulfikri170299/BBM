<x-app-layout>
    <div class="max-w-7xl mx-auto p-2 sm:p-6 lg:p-8 space-y-6 px-2 sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-slate-900 dark:text-white flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-slate-200 dark:border-white/10 pb-5">
            <div>
                <h1 class="text-xl sm:text-2xl font-bold text-slate-800 dark:text-white tracking-tight">Saldo Yang di Alihkan</h1>
                <p class="mt-1 text-xs sm:text-sm font-medium text-slate-600 dark:text-slate-400">Laporan pemotongan saldo kendaraan oleh Admin.</p>
            </div>
        </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left">
                    ...
                    <tbody class="divide-y divide-slate-200 dark:divide-white/5">
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center text-slate-600 dark:text-slate-400 italic font-medium">
