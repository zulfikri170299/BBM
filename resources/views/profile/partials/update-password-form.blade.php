<section>
    <header class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h2 class="text-xl font-bold text-slate-900 tracking-tight"> Keamanan Akun </h2>
            <p class="text-sm text-slate-500 mt-0.5"> Perbarui kata sandi Anda untuk menjaga keamanan akun. </p>
        </div>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="space-y-6 max-w-xl">
        ...
        <div>
            ...
            <div class="relative group">
                ...
                <input id="update_password_current_password" name="current_password" type="password" required autocomplete="current-password"
                    class="w-full pl-12 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition-all placeholder-slate-400"
        ...
        <div class="flex items-center gap-4 pt-2">
            <button type="submit" class="inline-flex items-center px-6 py-2.5 bg-gradient-to-r from-amber-500 to-amber-600 text-white font-bold rounded-xl shadow-lg shadow-amber-500/30 hover:shadow-xl hover:shadow-amber-500/40 transition-all transform hover:-translate-y-0.5">
