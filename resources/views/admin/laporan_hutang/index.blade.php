<x-app-layout>
    <div class="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h1 class="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">Laporan Hutang BBM</h1>
                <p class="mt-1 text-xs sm:text-sm font-medium text-slate-500">Monitoring riwayat hutang bon BBM oleh Satker.</p>
            </div>
                ...
                <table class="w-full text-sm text-left">
                    <thead class="text-xs text-slate-500 uppercase bg-slate-50/80 border-b border-slate-200">
                        <tr>
                            ...
                            <th class="px-6 py-4 font-bold">Satker</th>
                    ...
                    <tbody class="divide-y divide-slate-100">
                        @forelse($hutangs as $hutang)
                            <tr class="hover:bg-slate-50/50 transition">
                                ...
                                <td class="px-6 py-4">
                                    <div class="font-bold text-slate-800">{{ $hutang->satker->nama_satker }}</div>
                                </td>
                                <td class="px-6 py-4">
