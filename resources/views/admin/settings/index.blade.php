<x-app-layout>
    <div class="p-6 lg:p-8 space-y-6">
        ...
        @if(session('success'))
            <div x-data="{ show: true }" x-show="show" x-transition x-init="setTimeout(() => show = false, 3000)" class="bg-green-100 border border-green-200 text-green-700 px-4 py-3 rounded-xl relative" role="alert">
        ...
        <div class="bg-white rounded-2xl border border-slate-200/70 shadow-sm p-6">
            <form action="{{ route('admin.settings.update') }}" method="POST">
                ...
                <div class="space-y-6">
                    <div class="flex items-center justify-between p-4 border border-slate-200 rounded-xl bg-slate-50">
                        <div>
                            ...
                            <p class="text-sm text-slate-500">Izinkan akun Satker untuk menambah data kendaraan secara manual.</p>
                        </div>
                    ...
                    <div class="pt-4 border-t border-slate-100">
                        <h4 class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-4">Aktivasi Global Akun</h4>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="flex items-center justify-between p-4 border border-slate-200 rounded-xl bg-white shadow-sm">
                                <div>
                                    ...
                                    <a href="{{ route('admin.users.index', ['role' => 'admin_satker']) }}" class="text-[10px] font-bold text-indigo-600 hover:text-indigo-800 mt-2 inline-block uppercase tracking-wider">
                            ...
                            <div class="flex items-center justify-between p-4 border border-slate-200 rounded-xl bg-white shadow-sm">
                                <div>
                                    ...
                                    <a href="{{ route('admin.users.index', ['role' => 'personel']) }}" class="text-[10px] font-bold text-indigo-600 hover:text-indigo-800 mt-2 inline-block uppercase tracking-wider">
                                        &rarr; Pilih Akun per Individu
                                    </a>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                ...
                <div class="mt-8 flex justify-end">
                    <button type="submit" class="px-6 py-3 bg-indigo-600 text-white font-bold rounded-xl shadow-lg shadow-indigo-500/30 hover:bg-indigo-700 hover:shadow-indigo-500/50 transition-all">
                        Simpan Perubahan
                    </button>
                </div>
            </form>
