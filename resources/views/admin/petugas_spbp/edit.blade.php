    ...
    <div class="py-12 bg-slate-800/50 min-h-screen px-2 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-slate-900 border border-white/5 overflow-hidden shadow-sm sm:rounded-2xl border border-white/10">
                <div class="p-8">
                    <div class="mb-8">
                        <h3 class="text-lg font-bold text-slate-200">Edit Data Petugas</h3>
                        <p class="text-xs text-slate-400">Perbarui informasi petugas SPBP untuk keperluan laporan PDF.</p>
                    </div>
