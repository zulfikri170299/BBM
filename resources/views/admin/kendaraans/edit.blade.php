        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.kendaraans.update', $kendaraan) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-4">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('admin.kendaraans.index') }}" class="text-gray-500 hover:text-gray-700 font-semibold">Kembali</a>
                        </div>
                    </form>
                </div>
            </div>
