    ...
    <div class="p-2 sm:p-6 lg:p-8">
        <div class="max-w-md mx-auto space-y-6">
            ...
            <div class="text-center">
                ...
                <h1 class="text-2xl font-bold text-white">Pengisian Berhasil!</h1>
                <p class="text-sm text-slate-400 mt-1">Berikut adalah bukti transaksi pengisian BBM</p>
            </div>

            <!-- Struk Card -->
            <div class="bg-slate-900 rounded-2xl border border-white/10 shadow-sm overflow-hidden" id="struk-area">
                <!-- Header Struk -->
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-semibold text-slate-300">{{ $transaksi->petugas->name ?? '-' }} (Admin)</p>
                        </div>
                        <div class="text-right">
                            <p class="text-[10px] text-slate-400 font-medium uppercase tracking-wider">ID Transaksi</p>
                            <p class="text-sm font-mono font-bold text-slate-200">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-sm font-semibold text-slate-300">{{ $target->satker->nama_satker ?? '-' }}
                            </p>
                        </div>
                        <div>
                            <p class="text-[10px] text-slate-400 font-medium uppercase tracking-wider">
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-sm font-bold text-slate-200">{{ $target->jenis_bbm }}</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-2.5">
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-slate-400">Jumlah Pengisian</span>
                            <span
                                class="text-sm font-bold text-slate-200">{{ number_format($transaksi->liter, 0, ',', '.') }}
                                Liter</span>
                        </div>
                    </div>
                ...
                <!-- Footer -->
                <div class="px-6 py-3 bg-slate-800/50 text-center border-t border-white/5">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('admin.transaksi.index') }}"
                    class="flex-1 text-center px-6 py-3 bg-slate-800 text-slate-400 rounded-xl font-semibold text-sm hover:bg-slate-200 transition-colors">
