            ...
            <div class="bg-slate-900 border border-white/5 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-white">
                    ...
                    <form action="{{ route('admin.users.update', $user) }}" method="POST">
                        ...
                        @method('PUT')
                        <div class="mb-4">
                            <label for="name" class="block text-slate-300 text-sm font-bold mb-2">Nama:</label>
                            <input type="text" name="name" id="name" value="{{ $user->name }}"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-slate-300 leading-tight focus:outline-none focus:shadow-outline"
                                required>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <label for="username" class="block text-slate-300 text-sm font-bold mb-2">Username:</label>
                        ...
                        <div class="mb-4">
                            <label for="password" class="block text-slate-300 text-sm font-bold mb-2">Kata Sandi
                        ...
                        <div class="mb-4">
                            <label for="password_confirmation"
                                class="block text-slate-300 text-sm font-bold mb-2">Konfirmasi Kata Sandi:</label>
