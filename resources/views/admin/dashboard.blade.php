<x-app-layout>
    <div class="p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-8">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6 mt-2 sm:mt-4">
            <!-- Left Column: Charts -->
            ...
            <div class="space-y-4 sm:space-y-6">
                ...
                <div class="grid grid-cols-2 gap-3 sm:gap-4">
                    <div
                        class="bg-white rounded-xl sm:rounded-2xl border border-slate-200/70 p-3 sm:p-4 shadow-sm hover:shadow-md transition-shadow">
                        <div class="flex items-center gap-2 sm:gap-3">
                            <div class="p-1.5 sm:p-2 bg-violet-100 text-violet-600 rounded-lg">
                            ...
                            <div>
                                <p class="text-[9px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-tight">
                                    Personel</p>
                                <p class="text-base sm:text-lg font-black text-slate-900">{{ $stats['totalPersonel'] }}
                                </p>
                            </div>
                        </div>
                    </div>
                    <div
                        class="bg-white rounded-xl sm:rounded-2xl border border-slate-200/70 p-3 sm:p-4 shadow-sm hover:shadow-md transition-shadow">
                        <div class="flex items-center gap-2 sm:gap-3">
                            <div class="p-1.5 sm:p-2 bg-sky-100 text-sky-600 rounded-lg">
                                <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div>
                                <p class="text-[9px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-tight">
                                    Total Liter</p>
                                <p class="text-base sm:text-lg font-black text-slate-900 truncate">
                                    {{ number_format($stats['totalLiter'], 0, ',', '.') }}L</p>
                            </div>
                        </div>
                    </div>
                </div>
