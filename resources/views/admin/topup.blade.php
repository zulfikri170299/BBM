            ...
            <div class="bg-slate-900 border border-white/5 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-white">
                    ...
                    <form action="{{ route('admin.topup.process') }}" method="POST">
                        @csrf
                        <div class="mb-4">
                            <label for="amount" class="block text-slate-300 text-sm font-bold mb-2">Amount
                                (Liter):</label>
                        ...
                        <div class="mb-6">
                            <label for="topup_password" class="block text-slate-300 text-sm font-bold mb-2">Password Top
                                Up:</label>
